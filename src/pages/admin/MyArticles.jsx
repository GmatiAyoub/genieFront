...
function MyArticles() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-800 mb-6">Mes articles soumis</h1>
      {articles.length === 0 && <p className="text-slate-500">Vous n'avez encore soumis aucun article.</p>}
